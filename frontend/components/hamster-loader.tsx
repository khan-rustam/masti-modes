...
export default function HamsterLoader({ durationMs = 1200 }: HamsterLoaderProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] grid place-items-center bg-white/80 dark:bg-black/80 backdrop-blur-md">
      ...
      <style jsx>{`
        ...
        .wheel-and-hamster *, .wheel, .hamster, .hamster div, .spoke { position: absolute; }
        ...
        .wheel-and-hamster::before { content: ""; position: absolute; inset: 0; }
        /* Keyframes */
      ...
      `}</style>
      {/* build DOM per original structure */}
